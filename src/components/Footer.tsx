    ...
    <footer className="bg-gray-800 text-gray-300 mt-auto">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* About Section */}
          <div>
            <h3 className="text-white mb-4">Velookara Panchayat</h3>
            <p className="text-sm text-gray-400 leading-relaxed">
              Serving the people of Kadupaserry and surrounding areas in Thrissur District, Kerala. 
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-2 text-sm">
                ...
                <span>Velookara Panchayat Office<br />Kadupaserry, Thrissur District<br />Kerala - 680301</span>
              </div>
              ...
              <div className="flex items-center gap-2 text-sm">
                ...
                <span>info@velookara.gov.in</span>
              </div>
            </div>
          </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-6 text-center text-sm text-gray-400">
          <p>© 2025 Velookara Panchayat. All rights reserved.</p>
